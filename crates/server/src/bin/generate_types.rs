...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::task::TaskOpenPr::decl(),
        db::models::task::TaskWithAttemptStatus::decl(),
        db::models::task::OpenPr::decl(),
        ...
        services::services::git_host::github::cli::GitHubIssue::decl(),
        server::routes::github_issues::GitHubIssueToImport::decl(),
